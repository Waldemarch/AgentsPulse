...
class TestUsageEntries(unittest.TestCase):
    ...
    @patch('agentpulse.popup.POPUP_FIELDS', ['fve_hour', 'seven_day'])
    ...
    @patch('agentpulse.popup.POPUP_FIELDS', ['seven_day_sonnet'])
...
class TestSnapshotToDict(unittest.TestCase):
    ...
    @patch('agentpulse.popup.time_until', return_value='5h 0m')
    ...
    @patch('agentpulse.popup.POPUP_FIELDS', ['typo_field', 'seven_day'])
    @patch('agentpulse.popup.elapsed_pct', return_value=None)
    @patch('agentpulse.popup.time_until', return_value='')
    @patch('agentpulse.popup.midnight_positions', return_value=[])
    ...
    @patch('agentpulse.popup.format_credits', side_effect=lambda c: f'${c / 100:.2f}')
    ...
    @patch('agentpulse.popup.find_installations')
