...
from agentpulse.verbose import (
    _credentials_status,
    _dotnet_version,
    _dpi_info,
    _package_version,
...
class TestWebview2Version(unittest.TestCase):
    ...
    def test_runtime_found(self):
        ...
        with patch('agentpulse.verbose.winreg') as mock_winreg:
...
class TestDpiInfo(unittest.TestCase):
    ...
    def test_per_monitor_v2_150_percent(self):
        ...
        with patch('agentpulse.verbose.ctypes') as mock_ctypes:
...
class TestCredentialsStatus(unittest.TestCase):
    ...
    def test_found(self):
        ...
        with patch('agentpulse.verbose.Path') as mock_path, \
...
class TestSetupConsole(unittest.TestCase):
    ...
    def test_attaches_parent_console_first(self):
        ...
        with patch('agentpulse.verbose.ctypes') as mock_ctypes, \
             ...
             patch('agentpulse.verbose.sys'), \
             patch('agentpulse.verbose.os'):
...
class TestPrintStartupDiagnostics(unittest.TestCase):
    ...
    def test_contains_all_sections(self):
        ...
        buf = io.StringIO()
        with patch('sys.stdout', buf), \
             patch('agentpulse.verbose.ctypes') as mock_ctypes, \
             patch('agentpulse.verbose.locale') as mock_locale, \
             patch('agentpulse.verbose.platform') as mock_platform, \
             patch('agentpulse.verbose.winreg') as mock_winreg:
