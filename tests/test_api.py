...
from agentpulse.api import API_URL_USAGE, CLAUDE_CONFIG_DIR, CLAUDE_CREDENTIALS, _extract_server_message, _parse_retry_after, fetch_usage, read_access_token
...
class TestReadAccessToken(unittest.TestCase):
    ...
    def test_file_missing(self):
        ...
        with TemporaryDirectory() as tmp:
            ...
            with patch('agentpulse.api.CLAUDE_CREDENTIALS', fake_path):
    ...
    def test_valid_token(self):
        ...
        with TemporaryDirectory() as tmp:
            ...
            with patch('agentpulse.api.CLAUDE_CREDENTIALS', creds_file):
...
@patch('agentpulse.api.T', EN)
class TestFetchUsage(unittest.TestCase):
    """Tests for fetch_usage()."""

    @patch('agentpulse.api.api_headers', return_value=None)
    ...
    @patch('agentpulse.api.requests.get')
    @patch('agentpulse.api.api_headers', return_value={'Authorization': 'Bearer test'})
